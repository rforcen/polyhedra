...
class RendererGL(QOpenGLWidget):
    ...
    def sceneInit(self, gl):
        ...
        gl.glLightfv(gl.GL_LIGHT0, gl.GL_DIFFUSE, [0.5, 0.5, 0.5, 0.0])
        gl.glLightfv(gl.GL_LIGHT0, gl.GL_SPECULAR, [1, 1, 1, 0])
        gl.glLightfv(gl.GL_LIGHT0, gl.GL_POSITION, [1, 0.5, 5, 0])
        gl.glEnable(gl.GL_LIGHT0)

        gl.glLightfv(gl.GL_LIGHT1, gl.GL_AMBIENT, [0.1, 0.1, 0.1, 1.0])
        gl.glLightfv(gl.GL_LIGHT1, gl.GL_DIFFUSE, [0.5, 0.5, 0.5, 0.0])
        gl.glLightfv(gl.GL_LIGHT1, gl.GL_SPECULAR, [1, 1, 1, 0])
        gl.glLightfv(gl.GL_LIGHT1, gl.GL_POSITION, [-1, 0.5, -5, 0])
